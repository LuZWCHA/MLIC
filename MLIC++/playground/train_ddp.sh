...
torchrun --nproc_per_node=2 train.py --metrics mse --exp mlicpp_small_dec_mse_q1_finetune_ddp -c /nasdata2/private/zwlu/compress/naic2024/MLIC/MLIC++/playground/experiments/mlicpp_small_dec_mse_q1_finetune_ddp/checkpoints/checkpoint_005.pth.tar -m MLICPP_M_SMALL_DEC --gpu_id 0,1 -n 24 --lambda 0.0012 -lr 1e-4 --clip_max_norm 2.0 --seed 1984 --batch-size 128 -d /nasdata2/private/zwlu/compress/naic2024/datasets/
