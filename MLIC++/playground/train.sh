...
python train.py --metrics mse -c /nasdata2/private/zwlu/compress/naic2024/MLIC/MLIC++/playground/experiments/mlicpp_small_mse_q1/checkpoints/checkpoint_005.pth.tar --exp mlicpp_small_mse_q1 -m MLICPP_S --gpu_id 0 -n 48 --lambda 0.0018 -lr 1e-4 --clip_max_norm 1.0 --seed 1984 --batch-size 512 -d /nasdata2/private/zwlu/compress/naic2024/datasets/
