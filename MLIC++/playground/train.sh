...
python train.py --metrics mse -c /nasdata2/private/zwlu/compress/naic2024/MLIC/MLIC++/playground/experiments/mlicpp_small_mse_q1/checkpoints/checkpoint_166.pth.tar --exp mlicpp_small_mse_q1_finetune -m MLICPP_S --gpu_id 0 -n 32 --lambda 0.0012 -lr 2e-3 --clip_max_norm 1.0 --seed 1984 --batch-size 512 -d /nasdata2/private/zwlu/compress/naic2024/datasets/
